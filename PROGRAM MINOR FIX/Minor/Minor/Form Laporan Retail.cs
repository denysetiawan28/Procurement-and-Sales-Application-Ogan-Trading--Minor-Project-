...
namespace Minor
{
    public partial class Form_Laporan_Retail : Form
    {
        databaseEntities db = new databaseEntities();
        int total = 0;
        public Form_Laporan_Retail()
        {
            InitializeComponent();
        }
        ...
        {
            var temp = (from a in db.db_Form_Penjualan_Eceran
                        join b in db.db_Detail_Form_Penjualan_Eceran
                        on a.No_Form_Penjualan_Eceran equals b.No_Form_Penjualan_Eceran
                        where a.Tanggal.Contains(text)
                        select new { a.Tanggal, a.No_Form_Penjualan_Eceran, b.ID_Barang, b.Nama_Barang, b.Jumlah, b.Harga });
        ...
        private void Form_Laporan_Retail_Load(object sender, EventArgs e)
        {
